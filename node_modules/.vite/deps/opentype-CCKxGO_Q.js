	...
	for (var n = [], s = 0; s < t.length; s += 1) {
		...
		if (o !== 0 && l !== 0) {
			...
			if (u._defaultWidthX = f.defaultWidthX, u._nominalWidthX = f.nominalWidthX, f.subrs !== 0) {
				var h = l + f.subrs;
				u._subrs = ve(e, h + r).objects, u._subrsBias = gr(u._subrs);
			}
			u._privateDict = f;
		}
		n.push(u);
...
function sn(e, r, t, a) {
	t.tables.cff = {};
	var n = en(e, r), s = ve(e, n.endOffset, k.bytesToString), i = ve(e, s.endOffset), u = ve(e, i.endOffset, k.bytesToString);
	...
	if (t.defaultWidthX = m.defaultWidthX, t.nominalWidthX = m.nominalWidthX, m.subrs !== 0) {
		var y = x + m.subrs;
		t.subrs = ve(e, y).objects, t.subrsBias = gr(t.subrs);
...
//# sourceMappingURL=opentype-CCKxGO_Q.js.map